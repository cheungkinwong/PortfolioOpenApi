...
UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'99340466-4df1-4818-b72a-aa24dddfc887'
WHERE [Id] = N'00000000-0000-0000-0000-000000000001';
SELECT @@ROWCOUNT;


UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'55051ad9-b39a-4194-92b2-28c34c3609cf'
WHERE [Id] = N'00000000-0000-0000-0000-000000000002';
SELECT @@ROWCOUNT;


INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250806062502_Addcvmodel', N'9.0.6');

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'c6940a4c-4a5d-45b9-a82e-004015d4fd3a'
WHERE [Id] = N'00000000-0000-0000-0000-000000000001';
SELECT @@ROWCOUNT;


UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'2f373703-5e24-4b26-9a8d-0ac16afe847d'
WHERE [Id] = N'00000000-0000-0000-0000-000000000002';
SELECT @@ROWCOUNT;


INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250811132425_Addprojects', N'9.0.6');

UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'815fdb70-398f-4b1e-ae6a-ec3f97471253'
WHERE [Id] = N'00000000-0000-0000-0000-000000000001';
SELECT @@ROWCOUNT;


UPDATE [AspNetUsers] SET [ConcurrencyStamp] = N'cd51f176-7faa-4535-bc96-ede3d97a98ec'
WHERE [Id] = N'00000000-0000-0000-0000-000000000002';
SELECT @@ROWCOUNT;


INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250811133549_AddProjectTable', N'9.0.6');
