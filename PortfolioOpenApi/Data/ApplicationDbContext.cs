...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Education>().HasData(
            new Education { Id = 1, School = "VDAB", StartDate = new DateTime(2024, 1, 1), EndDate = null, SectionId = 2 },
            new Education { Id = 2, School = "BeCode", StartDate = new DateTime(2019, 1, 1), EndDate = new DateTime(2020, 1, 1), SectionId = 2 },
            new Education { Id = 3, School = "VDAB", StartDate = new DateTime(2010, 1, 1), EndDate = new DateTime(2011, 1, 1), SectionId = 2 },
            new Education { Id = 4, School = "AP Hoge School", StartDate = new DateTime(2007, 1, 1), EndDate = new DateTime(2009, 1, 1), SectionId = 2 }
        );
        ...
        builder.Entity<Project>().HasData(
            new Project { Id = 1, Name = "Project1", Description = "Project1" , Link="www.github.com/cheungkinwong/memory-game", Image="project1.jpg"},
            new Project { Id = 2, Name = "Project2", Description = "Project2", Link = "www.github.com/cheungkinwong/memory-game", Image = "project2.jpg" }
        );
    }
}
